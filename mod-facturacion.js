...
window.RCD_MODULOS.facturacion = function(el, ctx){
  ...
  async function antView(){
    ...
    bd.innerHTML=
      ...
      (rs.length?'<table class="mtable"><tr><th>Obra / Cliente</th><th style="text-align:right">Abonado</th><th style="text-align:right">Consumido</th><th style="text-align:right">Saldo</th><th>Estado</th><th></th></tr>'+
